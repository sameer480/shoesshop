...
const Register = () => {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    try {
      await googleRegister(credentialResponse.credential, formData.mobile);
      alert("Registration successful! Please log in.");
      navigate("/login");
    } catch (error) {
  ...
  return (
    ...
    >
      {/* Left image panel — hidden on mobile, shown on lg */}
      <div
      ...
      >
        ...
        <img
          src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?w=700&q=80"
          alt="shoe"
          style={{
            width: "78%",
            borderRadius: "24px",
      ...
      >
        ...
        >
          {/* Brand */}
          <div className="auth-brand" style={{ marginBottom: 36, textAlign: "center" }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <p style={{ textAlign: "center", color: "#555", fontSize: 14, marginTop: 4 }}>
              ...
              <Link to="/login" style={{ color: "#e31c1c", fontWeight: 700, textDecoration: "none" }}>
                Login
              </Link>
            </p>
          </form>
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .auth-brand { margin-bottom: 26px !important; }
